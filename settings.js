...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=jiZCxZ5b#JCteWpLxfkAczDmOZzAPG9xn5g-kcjR-eXH-_Et_D-4' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
SUDO: process.env.SUDO === undefined ? '94786073208' : process.env.SUDO,
SESSION_NAME: process.env.PORT === undefined ? "Ｂʟ𝙰𝙲𝙺  ᶻᴱᴿ |sᴇᴍʏᴀᴢᴀ ʙʙʜ" : process.env.SESSION_NAME,
